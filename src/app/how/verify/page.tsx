...
export default function HowVerifyPage() {
  return (
    ...
    <section className="relative mx-auto w-full max-w-3xl flex-1 px-4 py-10 pt-20 sm:px-6 sm:py-16 sm:pt-24">
      ...
      <p className="relative mt-8 text-xs uppercase tracking-[0.3em] text-lime-300 eyebrow">How it works · шаг 3</p>
    ...
    <PhotoStrip
      photo="https://images.unsplash.com/photo-1555949963-aa79ccee98ec?q=80&w=1600&auto=format&fit=crop"
      alt="Проверка кода"
      caption="DEV-VERIFY · Авторство подтверждено"
    />
    </>
  );
}
