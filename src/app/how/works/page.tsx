...
export default function HowWorksPage() {
  return (
    <>
    <section className="relative mx-auto w-full max-w-3xl flex-1 px-4 py-10 pt-20 sm:px-6 sm:py-16 sm:pt-24">
      ...
      <p className="relative mt-8 text-xs uppercase tracking-[0.3em] text-lime-300 eyebrow">How it works · шаг 2</p>
    ...
    <PhotoStrip
      photo="https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?q=80&w=1600&auto=format&fit=crop"
      alt="Рабочее место с кодом"
      caption="Tell the whole story · Расскажи всю историю"
    />
    </>
  );
}
